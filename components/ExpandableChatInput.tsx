...
export default function ExpandableChatInput({
  ...
  return (
    <View className="px-4 pb-2">
      <View
        className="bg-light-primary dark:bg-dark-primary border border-light-secondary dark:border-dark-secondary rounded-2xl overflow-hidden"
        style={{
          shadowColor: "#000",
