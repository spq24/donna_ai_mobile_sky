...
export default function ImageAttachment({
  ...
  if (showFileName && fileName) {
    return (
      <View
        className="bg-light-secondary dark:bg-dark-secondary border border-light-secondary dark:border-dark-secondary rounded-xl px-3 py-2 flex-row items-center gap-3"
  ...
  return (
    <View style={{ width: container, height: container, position: 'relative' }}>
      ...
      <Pressable
        onPress={onRemove}
        className="absolute -top-1 -right-1 w-5 h-5 bg-light-primary dark:bg-dark-primary rounded-full items-center justify-center border border-light-secondary dark:border-dark-secondary"
